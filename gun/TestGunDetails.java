...
public class TestGunDetails {
	public static void main(String[] args) {
		...
		GunDetails dto1 = new GunDetails();
		...
		GunDetails dto2 = new GunDetails();
		...
		GunDetails dto3 = new GunDetails();
		...
		GunDetails[] res=operations.getAllByTypes(Types.ASSAULT_RIFELS);
		...
		GunDetails[] response=operations.getByBarrelmaterial("bronze");
		...
		GunDetails upd =operations.updateComponentByGunName("phosporous nitrate", "AKM");
		System.out.println(upd.toString());
		System.out.println();
		System.out.println("update location by name-----");
		GunDetails upd1 =operations.updateLocationByGunName("MK14", "Abudabi");
		System.out.println(upd1.toString());
		System.out.println();
		System.out.println("get by scope---");
		GunDetails[] get1=operations.getAllByScope((byte)8);
		for (int k = 0; k < get1.length; k++) {
			System.out.println(get1[k]);
			
		}
		System.out.println();
		GunDetails del =operations.deleteByName("AKM");
