package com.xworkz.narrowing.dto;

public class Narrowing {

	//converting from double;
	public double a = 34.0;
	public float b = (float)a;
	
	public double a1 = 45.8;
	public long b1 = (long)a1;
	
	public double a2 = 3.07;
	public int b2 = (int)a2;
	
	public double a3 = 67.8;
	public char b3 = (char)a3;
	
	public double a4 = 32.7;
	public short b4 = (short)a4;
	
	public double a5 = 55.986;
	public byte b5 = (byte)a;
	
	//converting from float;
	public float c = 28.077f;
	public long d = (long)c;
	
	public float c1 = 55.6f;
	public int d1 = (int)c1;
	
	public float c2 = 106.88f;
	public char d2 = (char)c2;
	
	public float c3 = 453.8f;
	public short d3 = (short)c3;
	
	public float c4 = 12.006f;
